...
export const oauthController = async (req: Request, res: Response) => {
  ...
  const urlRedirect = `${envConfig.clientRedicrectCallback}?access_token=${result.access_token}&refresh_token=${result.refresh_token}&new_user=${result.newUser}&verify=${result.verify}`
